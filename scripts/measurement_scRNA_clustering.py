...
def main() :
    ...
    seurat_hvg = pd.read_csv("/home/bruce1996/repo/LIHC_anomaly_detection/data/scRNA-related-data/seurat_hvgs1346_list.txt",sep='\t',index_col=0)
    ...
    for condition in ['virus','patient'] :
        ...
        metric_df.to_csv("/home/bruce1996/repo/LIHC_anomaly_detection/data/scRNA-related-data/%s_voted_genes_random_sampling_cluster_result.txt" % condition,sep='\t')
